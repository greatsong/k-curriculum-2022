...
published 연결이 하나 이상 붙은 성취기준은 2,535건(39%)입니다.

| 학교급 | 연결 있음 / 전체 |
|---|---|
| 초등 1-2학년군 | 24 / 100 (24%) |
| 초등 3-4학년군 | 70 / 231 (30%) |
| 초등 5-6학년군 | 116 / 280 (41%) |
| 중학교 | 381 / 714 (53%) |
| 고등 공통 | 142 / 266 (53%) |
| 고등 선택 | 1,649 / 2,860 (58%) |
| 산업수요 전문교과 | 153 / 1,993 (8%) |

연결이 하나도 없는 보통교과 과목이 28개 있고 대부분 제2외국어(독일어·러시아어·베트남어·스페인어 계열)입니다. 후보 추출이 임베딩 유사도에 기대는데 외국어 성취기준은 다른 교과와 표면 유사도가 낮아 후보에 들지 못한 결과입니다. [로드맵](../README.md#로드맵)의 첫 항목입니다.
