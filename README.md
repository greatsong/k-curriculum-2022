...
**융합 관점으로 잇는 연결 3,916개**를 담은 공개 데이터셋입니다. 연결을 만들어낸
...
- **교사** — 자신의 교과 성취기준 하나를 선택하면, 다른 교과 성취기준 중 한 수업으로 연결되는 항목과 그 근거, 융합 주제, 수업 아이디어를
  바로 확인할 수 있습니다.
- **연구자** — 성취기준 6,444개를 점, 연결 3,916개를 선으로 구성한 그래프입니다. 교과 간 거리, 학교급 간 계열성, 융합 주제의
  분포를 계산할 수 있습니다.
...
것이므로, 깨진 수식·잘린
문장·해설 혼입은 0건입니다. 연결은 다릅니다. published 연결이 하나라도 붙은 성취기준은 2,570개(40%)이고, 학교급별로 보면 초등 1-2학년군 29%, 초등 3-4학년군 30%, 중학교 54%, 고등학교 57%입니다. 제2외국어 회화·독일어·러시아어 계열 11개 과목과 스포츠 문화에는 아직 연결이 없습니다. 게시된 연결 3,916개는 전부
...
- [ ] **제2외국어 남은 12과목** — 2026-09-06에 상대 과목을 지리·역사·문학·진로로 한정한 후보 추출로 16과목에 연결을 만들었지만([#1](../../issues/1)), 회화 6과목·독일어 3과목·생활 프랑스어·생활 러시아어·러시아어·스포츠 문화는 0.7대 후보만 있습니다. 사람이 읽어 올리는 검토가 필요합니다.
- [ ] **초등 1-2학년군 커버리지** — 100개 중 29개만 연결이 있습니다(2026-09-06 통합교과 8건 추가). 통합교과(바른 생활·슬기로운 생활·즐거운 생활)가 다른 교과와 어떻게 이어지는지는 별도 판정 프롬프트가 필요합니다.
- [ ] **candidate 0.7대 4,495건 검토** — 사람이 읽고 published로 올릴 후보입니다. 검토 결과를 되먹여 판정 기준을 정교화합니다.
